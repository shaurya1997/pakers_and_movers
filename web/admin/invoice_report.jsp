...
<%
    ...
    %>
<body>
 <jsp:useBean id="admin" class="Test.Invoice_Pojo"></jsp:useBean>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                 <%
                   ArrayList<Invoice_Pojo> data=dao.FetchI(code);
                 ...
                 <tr>
                       <td><%=obj.getINV_ID()%></td>
                     <td><%=obj.getENQ_ID()%></td>
                     <td><%=obj.getINV_DATE()%></td>
                      <td><%=obj.getPRICE()%></td>
                       <td><%=obj.getSECURITY_COST()%></td>
                        <td><%=obj.getEMP_ID()%></td>
                       <td><%=obj.getHAPPY_CODE()%></td>   
