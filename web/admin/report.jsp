  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ly"> <a href="employee1_report.jsp"> <i class="icon-user"></i> Employee_Report</a> </li>
        <li class="bg_lo"> <a href="vehicle1_report.jsp"> <i class="icon-truck"></i> Vehicle_Report</a> </li>
         <li class="bg_ls"><a href="customer1_report.jsp"><i class="icon-globe"></i> <span>Customer_Report</span></a></li>
          <li class="bg_lv"><a href="invoice_report.jsp"><i class="icon-road"></i> <span>Invoice_Report</span></a></li>
           <li class="bg_lr"><a href="feedback_report.jsp"><i class="icon-signin"></i> <span>Feedback_Report</span></a></li>
         <li class="bg_lr"><a href="enquiry_report.jsp"><i class="icon-signin"></i> <span>Enquiry_Report</span></a></li>
