    ...
    <section class="section-padding-70">
        ...
        <div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                                    <form class="registration" action="verify_user.jsp" method="POST">
			
                         		
                              <h2>Choose Your Roll</h2>
                              <br/>
                              <label class="container">
                                  <input type="radio" checked="checked" name="radio" required="true" value="customer">
                                 <span class="checkmark"></span>Customer
                              </label>
                              <label class="container">
                               <input type="radio" name="radio" required="true" value="admin">
                            <span class="checkmark"></span>Admin
                              </label>
                         <label class="container">
                             <input type="radio" name="radio" required="true" value="master_admin">
                        <span class="checkmark"></span>Master Admin
                           </label>
                            <br>
                            <br>
