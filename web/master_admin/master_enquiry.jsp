            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                 <%
                   ...
                   ArrayList<Enquiry_Pojo> data=dao.FetchEn(t);
                 ...
                 <tr>
                     ...
                     <td><%=obj.getCUST_ID()%></td>
                          ...
                          <td><%=obj.getSOURCE()%></td>
                            ...
                            <td><%=obj.getDOD()%></td>
                            <td><%=obj.getMSG()%>
                     <td><button class="generate" id="button">Generate</button></td>
               ...
               $('.update').click(function()
               {
                   ...
                   $(this).text($(this).text()=="Update"?"Save":"Update");
                    if($(this).text()=="Update")
                    {
                        ...
                        alert(txt);
                    var url = "customerUpdate.jsp?data="+txt;
...
//                    alert(txt);
                    var url = "customerDelete.jsp?id="+txt;
