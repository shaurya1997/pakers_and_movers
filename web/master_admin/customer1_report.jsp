...
<body>
 <jsp:useBean id="admin" class="Test.Customer_Pojo"></jsp:useBean>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                 <%
                       ...
                       ArrayList<Customer_Pojo> data=dao.FetchC(t);
                   
                   for(Customer_Pojo obj:data)
                   {
                   %>
                 <tr>
                     ...
                     <td><%=obj.getCUST_NAME()%></td>
                          ...
                          <td><%=obj.getMOB_NO()%></td>
                            <td><%=obj.getCUST_ADDRESS()%></td>
                            <td><%=obj.getCUST_EMAIL()%></td>
           ...
           $(document).ready(function()
           {
               $('.update').click(function()
               {
                   ...
                   if($(this).text()=='Update')
                   {
                       ...
                       {
                           if((count>0 && count<len-1) && count!=6)
