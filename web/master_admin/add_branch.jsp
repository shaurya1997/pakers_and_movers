      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="get_branch.jsp"  name="studentForm"  ng-controller="mainCtrl">
            ...
            function ajaxFunction()
            {
                ...
                <div class="controls">
                    <select name="txtsname" id="sid" onchange="ajaxFunction()" required >
		...
		<div class="control-group">
                ...
                <div class="controls">
                    <select id="ajaxDiv" name="txtcity" required>
                   </select>
                </div>
              </div>
              <div class="control-group">
