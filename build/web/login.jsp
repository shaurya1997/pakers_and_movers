    ...
    <section class="top-bar">
        <div class="container">
            ...
            <ul class="nav-right pull-right list-unstyled">
             <li> <a href="check_user_roll.jsp"><i class="fa fa-lock"></i> Login </a></li>
        ...
        <div class="row">
			...
			<div class="box-header">
	                	<h2>Login to your account</h2>
                         		...
                         		<label>User Name</label>
                                        <input type="text" class="form-control margin-bottom-20" name="email" required>
 		...
 		<!--<div class="col-md-8 col-sm-8 col-xs-12">
                            <div class="checkbox checkbox-default">
                                <label>choose Your Roll</label>
                                <br>
                               <input type="checkbox" id="checkbox2" checked="" name="checkbox">
