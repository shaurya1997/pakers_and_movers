            ...
            <nav class="navbar navbar-default ">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="main-navigation">
					   ...
					   <li><a href="online-booking.jsp">get a quote</a></li>  
                        </ul>
                         </div>
                    <!-- /.navbar-collapse -->
                ...
                <div id="services-2">
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <div class="services-grid">
                            ...
                            <h4>Trustable</h4>
                            <p>100% Safe and secure moving services, Well Trained Team members</p>
                        </div>
                    </div>
                    <!-- services grid -->
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <div class="services-grid">
                            ...
                            <h4>Discount</h4>
                            <p>We specialize in providing support with reliable & cost-effective solutions</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        ...
                        <div class="services-grid">
                            ...
                            <h4>Rewards</h4>
                            <p>Indias most economical Movers. Time Bound Delivery hassle free shifting.</p>
                        </div>
                    </div>
                    <!-- services grid -->
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <div class="services-grid">
                            ...
                            <p>Save upto 10% more from top rated movers in India.</p>
                        </div>
                    </div>
                    <!-- services grid -->
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <div class="services-grid">
                            ...
                            <h4>User Friendly</h4>
                            <p>We are responsive, careful & friendly on phone & mail No hidden charges!</p>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        ...
                        <div class="services-grid">
                            ...
                            <p>Transport accorss the globe .</p>
                        </div>
                    </div>
                    <!-- services grid -->
                    <div class="col-md-4 col-xs-12 col-sm-6">
                        <div class="services-grid">
                            ...
                            <h4>fast delivery</h4>
                            <p>We deliver as fast as possible with all security.</p>
                        </div>
                    </div>
                    <!-- services grid -->
                    <div class="col-md-4 col-xs-12 col-sm-6">
