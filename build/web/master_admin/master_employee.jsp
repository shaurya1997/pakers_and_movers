...
<%@page import="Test.Employee_Pojo"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
 <jsp:useBean id="admin" class="Test.Employee_Pojo"></jsp:useBean>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                 <%
                   //  int t=Integer.parseInt(request.getParameter("bid"));
                     String t=session.getAttribute("temp").toString();
                                          
                     
                   ArrayList<Employee_Pojo> data=dao.FetchE(t);
                 ...
                 <tr>
                     ...
                     <td><%=obj.getMOBILE_NO()%></td>
                     <td><%=obj.getBRANCH_ID()%></td>
                     <td><%=obj.getEMP_ADD()%></td>
                     <td><%=obj.getEMP_TYPE()%></td>
