  ...
  <div class="container-fluid" >
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lb"> <a href="admin1_report.jsp"> <i class="icon-dashboard"></i> Admin_Report</a> </li>
        <li class="bg_lg "> <a href="branch1_report.jsp"> <i class="icon-signal"></i> Branch_Report</a> </li>
        <li class="bg_ly"> <a href="master_employee_report.jsp"> <i class="icon-user"></i> Employee_Report</a> </li>
        <li class="bg_lo"> <a href="master_vehicle_report.jsp"> <i class="icon-truck"></i> Vehicle_Report</a> </li>
         <li class="bg_ls"><a href="master_customer_report.jsp"><i class="icon-globe"></i> <span>Customer_Report</span></a></li>
          <li class="bg_lv"><a href="master_invoice_report.jsp"><i class="icon-road"></i> <span>Invoice_Report</span></a></li>
           <li class="bg_lr"><a href="master_feedback_report.jsp"><i class="icon-signin"></i> <span>Feedback_Report</span></a></li>
         <li class="bg_lr"><a href="master_enquiry_report.jsp"><i class="icon-signin"></i> <span>Enquiry_Report</span></a></li>
