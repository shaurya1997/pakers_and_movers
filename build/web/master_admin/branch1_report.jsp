...
<body>
 <jsp:useBean id="admin" class="Test.Branch_Pojo"></jsp:useBean>
        ...
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
              ...
              <tbody>
                 <%
                   ArrayList<Branch_Pojo> data=dao.FetchB();
                   
                   for(Branch_Pojo obj:data)
                   {
                   %>
                 <tr>
                    <td><%=obj.getBRANCH_ID()%></td>
                     <td><%=obj.getBRANCH_ADD()%></td>
                     <td><%=obj.getCITY()%></td>
                                    <td><%=obj.getBRANCH_CON()%></td>
               ...
               $('.update').click(function()
               {
                   ...
                   $(this).text($(this).text()=="Update"?"Save":"Update");
                    if($(this).text()=="Update")
                    {
                        ...
                        alert(txt);
                    var url = "branchUpdate.jsp?data="+txt;
...
//                    alert(txt);
                    var url = "branchDelete.jsp?id="+txt;
